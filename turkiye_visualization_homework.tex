...
\subsection{Task 1A: Türkiye Map with City-Based Time Series}
...
\begin{figure}[H]
    ...
    \caption{Hand-drawn Türkiye map with labeled cities and mini line charts (Task 1A).}
    \label{fig:task1a-map}
\end{figure}

\textbf{Short explanation placeholder:}

\placeholder{Write a short explanation of how the cities were placed, how mini time-series charts were used, and what this overview reveals at a glance.}

\subsection{Task 1B: Three Socio-Economic Indicators as Line Charts}

In this task, the three national indicators were drawn as separate line charts on paper for the same time period.

\begin{figure}[H]
    \centering
    \fbox{\rule{0pt}{2.2in}\rule{0.9\textwidth}{0pt}}
    \caption{Placeholder for the hand-drawn line charts of unemployment rate, GDP per capita, and inflation. Replace this box with the scanned image or photo of Task 1B.}
    \label{fig:task1b-indicators}
\end{figure}

\textbf{Short explanation placeholder:}

\placeholder{Write a short explanation of why line charts were chosen, what temporal trends are visible, and how these charts support later comparison.}

\subsection{Task 1C: Formulated Question}

Based on Task 1A and Task 1B, the following question was formulated:
...
\placeholder{Write 1--2 paragraphs explaining why this question naturally emerges from the data and why visualization is needed to answer it effectively.}

% =========================================================
\section{Task 2: Three Visualization Sketches}

This section presents three visualization sketches designed to answer the main question. One of the sketches is intentionally more abstract, as requested in the homework. For each sketch, placeholders are provided for the image and explanation.

% -------------------------
\subsection{Sketch 1: Multi-Line Comparison View}

\begin{figure}[H]
    \centering
    \fbox{\rule{0pt}{2.4in}\rule{0.9\textwidth}{0pt}}
    \caption{Placeholder for Sketch 1 image. Insert the hand-drawn or digital sketch here.}
    \label{fig:sketch1}
\end{figure}

\textbf{Visualization type:} \placeholder{Example: multi-line chart / coordinated line chart / small multiples}

\textbf{Goal:} \placeholder{Explain what this sketch tries to reveal.}

\textbf{Design rationale:}

\placeholder{Explain what variables are encoded using position, color, slope, or grouping. Mention why this representation is appropriate for temporal comparison. Use class terminology such as marks, channels, encoding, scale, comparison, trend, overview, or correlation.}
